...
public class Program {
    public static void main(String[] args) {
        ...
        Post post1 = new Post(autor1, "Como implementar Terraform", "Implementando IaC com Terraform bla bla bla", Categorias.DEVOPS);

        Post post2 = new Post(autor1, "Trabalhando com a interface Set em Java", "A interface Set eh implementada por varias colecoes em Java bla bla bla", Categorias.DESENVOLVIMENTO);

        Post post3 = new Post(autor2, "Publicando pipelines GitLab", "Para publicar pipelines no GitLab bla bla bla", Categorias.DEVOPS);

        Post post4 = new Post(autor2, "Azure Service Bus por onde comecar", "Primeiramente, eh necessario entender que bla bla bla", Categorias.DEVOPS);

        Post post5 = new Post(autor2, "TDD de forma simples", "O processo de desenvolvimento de software TDD bla bla bla", Categorias.DESENVOLVIMENTO);

        Post post6 = new Post(autor3, "Hadoop: A ferramenta que vai facilitar seu processamento de dados", "Hadoop eh uma ferramente bla bla bla", Categorias.DATA_SCIENCE);

        Post post7 = new Post(autor3, "Hadoop: A ferramenta que vai facilitar seu processamento de dados", "A ferramenta Hadoop bla bla bla", Categorias.DATA_SCIENCE);
