...
public class Program {
  public static void main(String[] args) {
    ...
    System.out.printf(
        Locale.GERMANY,
        "%s - %.2f\n",
        pedido1.getFrete().getTipoProvedorFrete(),
        pedido1.getFrete().getValor());
    ...
    System.out.printf(
        Locale.GERMANY,
        "%s - %.2f\n",
        pedido2.getFrete().getTipoProvedorFrete(),
        pedido2.getFrete().getValor());
    ...
    System.out.printf(
        Locale.GERMANY,
        "%s - %.2f\n",
        pedido3.getFrete().getTipoProvedorFrete(),
        pedido3.getFrete().getValor());
    ...
    System.out.printf(
        Locale.GERMANY,
        "%s - %.2f\n",
        pedido4.getFrete().getTipoProvedorFrete(),
        pedido4.getFrete().getValor());
