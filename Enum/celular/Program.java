...
public class Program {
    public static void main(String[] args) {
        ...
        try {
            celular.atualizarContato(new Contato("John Bannons", "32214332", TipoNumero.CASA), new Contato("John Bannons", "32214333", TipoNumero.CASA));
            celular.listarContatos();
        } catch (Exception ex) {
            System.out.println(ex.getMessage());
        }
        ...
        try {
            celular.atualizarContato(new Contato("John", "32214332", TipoNumero.CASA), new Contato("John Bannons", "32214333", TipoNumero.CASA));
            celular.listarContatos();
        } catch (Exception ex) {
            System.out.println(ex.getMessage());
        }
